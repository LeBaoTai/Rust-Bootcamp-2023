...
impl Hello for Student {
    fn say_hi(&self) -> String {
        String::from("Hello from Student")
    }
    
    fn say_something(&self) -> String {
        String::from("I'm a student of Sai Gon University")
    }
}
//TODO
struct Teacher {}
impl Hello for Teacher {
    fn say_hi(&self) -> String {
        String::from("Hello from Teacher")
    }
    
    fn say_something(&self) -> String {
        String::from("From Sai Gon University with love")
    }
}
...
mod tests {
    ...
    fn exercise1_should_work() {
        let s = Student {};
        assert_eq!(s.say_hi(), "Hello from Student");
        assert_eq!(s.say_something(), "I'm a student of Sai Gon University");
    
        let t = Teacher {};
        assert_eq!(t.say_hi(), "Hello from Teacher");
        assert_eq!(t.say_something(), "From Sai Gon University with love");   
    }
